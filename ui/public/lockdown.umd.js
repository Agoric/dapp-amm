...
(() => {
  const functors = [
    ...
    ({
      ...
      /** @type {<K, V>(thisArg: WeakMap<K, V>, ...args: Parameters<WeakMap<K,V>['get']>) => ReturnType<WeakMap<K,V>['get']>} */ $h‍_once.weakmapDelete(
        weakmapDelete,
      );
      ...
      const weaksetGet = uncurryThis(weaksetPrototype.get);
      $h‍_once.weaksetGet(weaksetGet);
  ...
  `);
      ...
      $h‍_imports([
        [
          ...
          [
            ...
            ['immutableObject', [$h‍_a => (immutableObject = $h‍_a)]],
            ['proxyRevocable', [$h‍_a => (proxyRevocable = $h‍_a)]],
            ['weaksetAdd', [$h‍_a => (weaksetAdd = $h‍_a)]],
          ],
        ],
        [
          './scope-constants.js',
          [['getScopeConstants', [$h‍_a => (getScopeConstants = $h‍_a)]]],
        ],
        [
          './scope-handler.js',
          [['createScopeHandler', [$h‍_a => (createScopeHandler = $h‍_a)]]],
        ],
        [
          './transforms.js',
          [
        ...
        [
          './make-evaluate-factory.js',
          [['makeEvaluateFactory', [$h‍_a => (makeEvaluateFactory = $h‍_a)]]],
        ],
        ['./error/assert.js', [['assert', [$h‍_a => (assert = $h‍_a)]]]],
      ]);
      ...
      const makeSafeEvaluator = ({
        ...
        const safeEvaluate = (source, { localTransforms = [] } = {}) => {
          ...
          try {
            ...
            const unsafeEvalWasStillExposed =
              scopeController.allowNextEvalToBeUnsafe;
            scopeController.allowNextEvalToBeUnsafe = false;
            if (unsafeEvalWasStillExposed) {
              ...
              // eslint-disable-next-line @endo/no-polymorphic-call
              assert.fail(
                d`handler did not reset allowNextEvalToBeUnsafe ${err}`,
              );
            }
          }
        };
    ...
    ({
      ...
      $h‍_imports([
        ...
        [
          ...
          [
            ...
            [
              'rejectSomeDirectEvalExpressions',
              [$h‍_a => (rejectSomeDirectEvalExpressions = $h‍_a)],
            ],
          ],
        ],
        [
          './make-safe-evaluator.js',
          [['makeSafeEvaluator', [$h‍_a => (makeSafeEvaluator = $h‍_a)]]],
        ],
      ]);
      ...
      const provideCompartmentEvaluator = (compartmentFields, options) => {
        ...
        if (__moduleShimLexicals__ === undefined && !sloppyGlobalsMode) {
          ...
          const { globalObject, globalLexicals, knownScopeProxies } =
            compartmentFields;
    ...
    ({
      ...
      $h‍_imports([
        ...
        [
          ...
          [['makeEvalFunction', [$h‍_a => (makeEvalFunction = $h‍_a)]]],
        ],
        [
    ...
    ({
      ...
      const loadWithoutErrorAnnotation = async (
        ...
        const { importHook, moduleMap, moduleMapHook, moduleRecords } =
      ...
      $h‍_imports([
        ...
        [
          ...
          [
            ...
            [
              'reflectGetOwnPropertyDescriptor',
              [$h‍_a => (reflectGetOwnPropertyDescriptor = $h‍_a)],
            ],
    ...
    ({
      ...
      $h‍_imports([
        ...
        [
          './module-proxy.js',
          [['getDeferredExports', [$h‍_a => (getDeferredExports = $h‍_a)]]],
        ],
        [
          './commons.js',
          [
        ...
        [
          ...
          [['compartmentEvaluate', [$h‍_a => (compartmentEvaluate = $h‍_a)]]],
        ],
      ]);
        ...
        function imports(updateRecord) {
          ...
          for (const [specifier, importUpdaters] of updateRecord) {
            ...
            if (arrayIncludes(exportAlls, specifier)) {
              ...
              for (const [importName, importNotify] of entries(
                importNotifiers,
              )) {
      ...
      $h‍_imports([
        ...
        [
          ...
          [
            [
              'setGlobalObjectConstantProperties',
              [$h‍_a => (setGlobalObjectConstantProperties = $h‍_a)],
            ],
            [
              'setGlobalObjectMutableProperties',
              [$h‍_a => (setGlobalObjectMutableProperties = $h‍_a)],
            ],
            [
              'setGlobalObjectEvaluators',
        ...
        [
          ...
          [
            [
              'isValidIdentifierName',
              [$h‍_a => (isValidIdentifierName = $h‍_a)],
            ],
          ],
        ],
        [
        ...
        function Compartment(endowments = {}, moduleMap = {}, options = {}) {
          ...
          for (const [specifier, aliasNamespace] of entries(moduleMap || {})) {
            if (typeof aliasNamespace === 'string') {
              ...
              weakmapGet(moduleAliases, aliasNamespace) === undefined
            ) {
    ...
    ({
      ...
      let arrayPush, arraySlice, freeze, assert;
      $h‍_imports([
        [
          './commons.js',
          [
    ...
    ({
      ...
      $h‍_imports([
        ...
        [
          './assert.js',
          [['loggedErrorHandler', [$h‍_a => (defaultHandler = $h‍_a)]]],
        ],
        [
          './console.js',
          [['makeCausalConsole', [$h‍_a => (makeCausalConsole = $h‍_a)]]],
        ],
        [
    ...
    ({
      ...
      $h‍_imports([
        ...
        [
          './compartment-shim.js',
          [['InertCompartment', [$h‍_a => (InertCompartment = $h‍_a)]]],
        ],
      ]);
      ...
      function tameRegExpConstructor(regExpTaming = 'safe') {
        ...
        const makeRegExpConstructor = (_ = {}) => {
          ...
          defineProperties(ResultRegExp, {
            ...
            [speciesSymbol]: getOwnPropertyDescriptor(
              FERAL_REG_EXP,
              speciesSymbol,
            ),
          });
    ...
    ({
       ...
       * @param {(Object) => void} markVirtualizedNativeFunction
       */
      function whitelistIntrinsics(intrinsics, markVirtualizedNativeFunction) {
    ...
    ({
      ...
      $h‍_imports([
        ...
        [
          './error/stringify-utils.js',
          [['enJoin', [$h‍_a => (enJoin = $h‍_a)]]],
        ],
        [
          './make-hardener.js',
        ...
        [
          ...
          [['default', [$h‍_a => (tameRegExpConstructor = $h‍_a)]]],
        ],
        [
          './enable-property-overrides.js',
          [['default', [$h‍_a => (enablePropertyOverrides = $h‍_a)]]],
        ],
        [
        ...
        [
          ...
          [['tameFunctionToString', [$h‍_a => (tameFunctionToString = $h‍_a)]]],
        ],
        [
          './tame-domains.js',
        ...
        [
          ...
          [['default', [$h‍_a => (tameErrorConstructor = $h‍_a)]]],
        ],
        [
          './error/assert.js',
          [
    ...
    ({
      ...
      $h‍_imports([
        ...
        [
          './src/tame-function-tostring.js',
          [['tameFunctionToString', [$h‍_a => (tameFunctionToString = $h‍_a)]]],
        ],
        [
          './src/intrinsics.js',
          [['getGlobalIntrinsics', [$h‍_a => (getGlobalIntrinsics = $h‍_a)]]],
        ],
        [
          './src/lockdown-shim.js',
          [['lockdown', [$h‍_a => (lockdown = $h‍_a)]]],
        ],
        [
        ...
        ['./src/error/assert.js', [['assert', [$h‍_a => (assert = $h‍_a)]]]],
      ]);
  ...
  functors[9]({
    ...
    onceVar: {
      ...
      rejectSomeDirectEvalExpressions:
        cells[9].rejectSomeDirectEvalExpressions.set,
  ...
  functors[15]({
    ...
    onceVar: {
      setGlobalObjectConstantProperties:
        cells[15].setGlobalObjectConstantProperties.set,
      setGlobalObjectMutableProperties:
        cells[15].setGlobalObjectMutableProperties.set,
